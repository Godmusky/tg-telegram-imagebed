...
from .media_batch import _MediaBatch, _media_group_batches, _flush_media_group, _MAX_BATCH_ITEMS, _cleanup_stale_batches, _enforce_batch_limit
...
async def handle_photo(update: Update, context):
    ...
    try:
        ...
        tg_file, filename, content_type, file_unique_id = _extract_file_from_message(
            message, settings_manager.get_allowed_extensions, _get_mime_type
        )
